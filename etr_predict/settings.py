"""
Django settings for etr_predict project.
...
SECRET_KEY = 'j#rgt4-%pki+e-(%h9^oik)tjdnymc8jx7o@8)gyv(6vc*s69n'
...
ROOT_URLCONF = 'etr_predict.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['prognose/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors':[
                ...
                'etr_predict.context_processors.app_info_menu',
            ],
        },
    },
]

WSGI_APPLICATION = 'etr_predict.wsgi.application'
