...
def loaddata_pd():
    ...
    """
    dataset = pd.read_csv('prognose/static/data/filterdata.csv', encoding='SHIFT-JIS', sep=";",
                          low_memory=False)
...
def load_data():
    ...
    """
    # print('load data')
    with open('prognose/static/data/filterdata.csv', 'rt') as file:
        next(file)
